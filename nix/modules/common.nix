# Shared seam for the ezpz-dndz-server NixOS and nix-darwin modules.
...
# systemd vs launchd.  This file exists anyway so the project author
# has a single, well-known location to drop a shared option, a shared
# default, or a cross-platform health assertion: just add it here and
# the module-merge system fans it out to both platforms with no
