...
- *Legendary Action available* — ~legendaryActionStrip~.  Lists every queue
  ...
  ~QueueScrollTo~ to bring the creature's card to the top of the queue.
  Filters: not the currently-active creature (rule: LA fires on OTHER creatures'
  turn-ends), not down, not dead.
