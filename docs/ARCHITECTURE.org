...
| ~condition_preset_sets~ → ~condition_presets~ | 0002, 0005 | Saved Add-Condition forms.                                        |
| ~save_chain_sets~ → ~save_chains~ → ~save_chain_effects~ | 0002, 0005 | Save Chain preset recipes.                                        |
...
| ~encounters~ (+ creatures / conditions / save notices / recharge abilities / pips / treasure + its contributions / items) | 0004, 0005 | The live encounter, fully typed — treasure settings flatten onto the ~encounters~ row itself; absent row reads as ~null~. |
