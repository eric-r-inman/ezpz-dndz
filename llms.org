...
the canonical record of what changed; =docs/ARCHITECTURE.org=
captures load-bearing decisions.  Summarize a change in the chat
reply rather than in a tracked doc.
