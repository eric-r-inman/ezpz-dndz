...
betaFeaturesSection =
    section [ class "about-page__section" ]
        ...
        , h3 [] [ text "Dice Roller" ]
        , p []
            [ text "The \"Roll\" button in the Actions column opens the dice roller, which accepts formula or manual values. The dice roller also serves as an auto-roller for stat block rolls (ability checks, saving throws, actions). It's wired into creature cards too, for initiative rolls, healing, damage, and falling damage. The last 4 roll results are shown under the Roll button, and the last 30 rolls are recorded in the dice roller itself." ]
        , h3 [] [ text "Stat Block" ]
        , p []
        ...
        , p []
            [ text "Tunable encounter generator, using creatures from the Compendium. Opened via \"Random\" under Compendium in the Actions column." ]
        , p []
