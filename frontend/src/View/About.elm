...
betaFeaturesSection =
    section [ class "about-page__section" ]
        ...
        , p []
            [ text "Roll treasure for enemies in the active encounter queue. Optional controls for tweaking the results to your liking: adjust \"Tune your rolls\" first, but for more control \"Edit treasure tables\". Lives in the Treasure panel of the editor column." ]
        , p []
        ...
        , p []
            [ text "Tunable encounter generator, using creatures from the Compendium. Opened from the Random Encounter panel in the editor column." ]
        , p []
